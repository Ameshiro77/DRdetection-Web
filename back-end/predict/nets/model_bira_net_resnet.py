...
class BiraNet_half(nn.Module):
    def __init__(self, last_channel_dim=512,PRE=True):
        super().__init__()
...
class BiraNet_ResNet(nn.Module):
    def __init__(self, last_channel_dim, classes_num,PRE=True):
        super(BiraNet_ResNet, self).__init__()
        self.biranet_half_1 = BiraNet_half(last_channel_dim,PRE=PRE)
        self.biranet_half_2 = BiraNet_half(last_channel_dim,PRE=PRE)
        self.denses = nn.Sequential(
